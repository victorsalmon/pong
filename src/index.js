...
if (confirm('Do you want to configure pong? If yes, you must enter a value and each must be a number.')) {
    ...
    config.ballSpeed = parseInt(prompt('In pixels/tick, how fast should the ball fly per tick? (default is 4)', 4))
    ...
    config.paddleSpeed = parseInt(prompt('In pixels/keypress, how far should the paddles travel per key press? (default is 10)', 10))
}
